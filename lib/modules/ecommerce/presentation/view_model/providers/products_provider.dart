...
final productsProvider =
    AsyncNotifierProvider<ProductsNotifier, PaginatedResponse<ProductModel>>(
      ProductsNotifier.new,
    );

class ProductsNotifier extends AsyncNotifier<PaginatedResponse<ProductModel>>
  ...
  @override
  FutureOr<PaginatedResponse<ProductModel>> loadData( PaginatedRequest request,
  ) async {
    try {
      final res = await productRepository.getProducts(query: request.toJson());
      return res.fold(
        (l) {
